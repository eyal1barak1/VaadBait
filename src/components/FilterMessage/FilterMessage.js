...
function FilterMessage(props) {
    ...
    const { filteredText, onFilterChange, FilterPriority, Sort } = props;
    ...
    return (
        <Container>
            <Row>
                ...
                <Col>
                    <Form.Group onChange={e => Sort(e.target.id)} className="filter-field" controlId="formBasicCheckboxFirst">
